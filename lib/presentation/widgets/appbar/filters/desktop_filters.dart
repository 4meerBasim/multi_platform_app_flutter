...
class DesktopFilters extends StatefulWidget {
  const DesktopFilters({super.key});

  @override
  State<DesktopFilters> createState() => _DesktopFiltersState();
}

class _DesktopFiltersState extends State<DesktopFilters> {
  int selectedIndex = 0;
